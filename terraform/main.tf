...
resource "aws_iam_role" "GitHubActions-ECR-Push-2" {
  name = "GitHubActions-ECR-Push-2"
...
resource "aws_iam_role_policy" "AmazonEC2ContainerRegistryPowerUser" {
  name = "AmazonEC2ContainerRegistryPowerUser"
  role = aws_iam_role.GitHubActions-ECR-Push-2.id
